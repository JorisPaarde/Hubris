...
Drain and heal where available in phase V, which allowed for enemies to be killed when the game was actually over. This broke the game.|Added line to block use of these actions in phase V to template.
