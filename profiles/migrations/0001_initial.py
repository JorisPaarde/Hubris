    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hand', models.ManyToManyField(to='profiles.Card')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profiles.player_type')),
                ('user', models.ForeignKey(default='bogus', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
